...
public class HelpFormatter
{
    ...
    public void printUsage(final PrintWriter pw, final int width, final String app, final Options options)
    {
        ...
        for (final Iterator<Option> it = optList.iterator(); it.hasNext();)
        {
            ...
            {
                appendOption(buff, option, option.required);
            }
    ...
    private void appendOption(final StringBuffer buff, final Option option, final boolean required)
    {
        ...
        {
            buff.append(option.opt == null ? longOptSeparator : " ");
    ...
    protected StringBuffer renderOptions(final StringBuffer sb, final int width, final Options options, final int leftPad, final int descPad)
    {
        ...
        for (final Option option : optList)
        {
            ...
            if (option.opt == null)
            {
                optBuf.append(lpad).append("   ").append(defaultLongOptPrefix).append(option.longOpt);
            }
            else
            {
                ...
                {
                    optBuf.append(',').append(defaultLongOptPrefix).append(option.longOpt);
                }
            }
            ...
            if (option.hasArg())
            {
                ...
                else
                {
                    ...
                    optBuf.append("<").append(argName != null ? option.getArgName() : defaultArgName).append(">");
                }
            }
